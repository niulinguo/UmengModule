...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UMengManager.reportError(String.valueOf(System.currentTimeMillis()));
    ...
    protected void onResume() {
        super.onResume();
        UMengManager.onPageStart("主页面");
        UMengManager.onActivityResume(this);
    }

    @Override
    protected void onPause() {
        super.onPause();
        UMengManager.onPageEnd("主页面");
        UMengManager.onActivityPause(this);
    }
